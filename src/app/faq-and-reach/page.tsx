    ...
    <main className="min-h-screen bg-background text-foreground pt-36 md:pt-44 pb-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto mb-16">
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-[#2a060c] via-[#1e0408] to-[#140205] text-white shadow-2xl p-8 sm:p-14 border border-gold/40">
          ...
          <div className="relative z-10 max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 border border-white/20 text-gold text-[11px] font-bold uppercase tracking-wider mb-6 backdrop-blur-md shadow-sm">
            ...
            <p className="text-subheading text-white/80 mb-8 leading-relaxed font-light">
            ...
            <div className="flex flex-wrap gap-4">
              <a 
                href="#official-faqs" 
                className="px-8 py-3.5 rounded-full bg-white hover:bg-white/90 text-black text-[13px] tracking-wider uppercase font-bold shadow-lg transition-all transform hover:-translate-y-0.5 flex items-center gap-2"
              >
              ...
              <a 
                href="#how-to-reach" 
                className="px-8 py-3.5 rounded-full bg-white/10 hover:bg-white/20 text-white text-[13px] tracking-wider uppercase font-bold border border-white/20 backdrop-blur-md transition-all flex items-center gap-2"
              >
      ...
      <div className="max-w-7xl mx-auto mb-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-card dark:bg-[#1e0408] p-6 rounded-2xl shadow-sm border border-border/60 flex items-center gap-4">
          ...
          <div>
            <span className="text-small-label font-semibold text-muted-foreground uppercase block">By Road</span>
            <h4 className="text-card-title font-bold text-foreground">72 km from Jaipur</h4>
            <p className="text-caption text-muted-foreground mt-0.5">14 Roadways buses daily</p>
          </div>
        </div>
        ...
        <div className="bg-card dark:bg-[#1e0408] p-6 rounded-2xl shadow-sm border border-border/60 flex items-center gap-4">
          ...
          <div>
            <span className="text-small-label font-semibold text-muted-foreground uppercase block">By Rail</span>
            <h4 className="text-card-title font-bold text-foreground">Banasthali-Newai (7 km)</h4>
            <p className="text-caption text-muted-foreground mt-0.5">On Jaipur-Mumbai Mainline</p>
          </div>
        </div>
        ...
        <div className="bg-card dark:bg-[#1e0408] p-6 rounded-2xl shadow-sm border border-border/60 flex items-center gap-4">
          ...
          <div>
            <span className="text-small-label font-semibold text-muted-foreground uppercase block">By Air</span>
            <h4 className="text-card-title font-bold text-foreground">Jaipur Airport (59 km)</h4>
            <p className="text-caption text-muted-foreground mt-0.5">Own Licensed Airfield on campus</p>
          </div>
        </div>
        ...
        <div className="bg-card dark:bg-[#1e0408] p-6 rounded-2xl shadow-sm border border-border/60 flex items-center gap-4">
          ...
          <div>
            <span className="text-small-label font-semibold text-muted-foreground uppercase block">Campus Radio</span>
            <h4 className="text-card-title font-bold text-foreground">90.4 MHz FM</h4>
            <p className="text-caption text-muted-foreground mt-0.5">30 km community reach</p>
          </div>
        </div>
      </div>
      ...
      <div id="official-faqs" className="max-w-5xl mx-auto mb-20 scroll-mt-8">
        <div className="text-center max-w-3xl mx-auto mb-10">
          <h2 className="text-section-heading font-bold text-foreground font-serif mb-4">
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-8">
          {[
            ...
            <button
              ...
              className={`px-5 py-2.5 rounded-xl text-button font-semibold transition-all ${
          ...
          {filteredFaqs.map((faq) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="text-card-title font-bold text-foreground flex items-center gap-3">
                    <span className="w-7 h-7 rounded-full bg-primary/10 dark:bg-primary/30 text-primary dark:text-gold font-mono text-small-label flex items-center justify-center shrink-0 border border-primary/20">
                      Q{faq.id}
                    </span>
                    {faq.question}
                  </span>
                ...
                {isOpen && (
                  <div className="px-6 pb-6 pt-2 border-t border-border/40 text-body text-muted-foreground leading-relaxed">
                    <p className="mb-4">{faq.answer}</p>
                    {faq.highlight && (
                      <div className="p-3 rounded-xl bg-primary/5 dark:bg-primary/20 border border-primary/20 text-small-label text-foreground font-semibold flex items-center gap-2">
      ...
      <div id="how-to-reach" className="max-w-7xl mx-auto mb-20 scroll-mt-8">
        <div className="bg-[#2a060c] dark:bg-[#1e0408] text-white rounded-3xl p-8 sm:p-14 shadow-2xl border border-gold/40">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <span className="px-3.5 py-1 rounded-full bg-primary/20 text-gold text-small-label font-semibold uppercase tracking-wider inline-block mb-3 border border-primary/30">
              Location & Travel Guide
            </span>
            <h2 className="text-section-heading font-bold font-serif mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-black/30 p-6 sm:p-8 rounded-2xl border border-white/10 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-card-title font-bold mb-3 text-white">By Road (Highways & Buses)</h3>
                ...
                <ul className="text-caption text-white/80 space-y-2.5">
              ...
              <div className="pt-6 mt-6 border-t border-white/10 text-caption text-gold/80 font-mono">
            ...
            <div className="bg-black/30 p-6 sm:p-8 rounded-2xl border border-white/10 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-card-title font-bold mb-3 text-white">By Rail (Banasthali-Newai Station)</h3>
                <p className="text-body text-white/80 leading-relaxed mb-6">
              ...
              <div className="pt-6 mt-6 border-t border-white/10 text-caption text-emerald-400/80 font-mono">
            ...
            <div className="bg-black/30 p-6 sm:p-8 rounded-2xl border border-white/10 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-card-title font-bold mb-3 text-white">By Air (Jaipur Airport & Airfield)</h3>
                <p className="text-body text-white/80 leading-relaxed mb-6">
              ...
              <div className="pt-6 mt-6 border-t border-white/10 text-caption text-purple-400/80 font-mono">
      ...
      <div className="max-w-7xl mx-auto mb-16">
        <div className="text-center max-w-3xl mx-auto mb-10">
          <h2 className="text-section-heading font-bold font-serif text-foreground mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-card dark:bg-[#1e0408] p-6 rounded-2xl border border-border/60 shadow-sm">
            <h4 className="text-card-title font-bold text-foreground mb-3 flex items-center gap-2">
