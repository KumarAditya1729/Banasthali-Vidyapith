    ...
    <main className="min-h-screen bg-background text-foreground pt-36 md:pt-44 pb-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto mb-16">
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-[#800000] via-[#5a0c16] to-amber-900 text-white shadow-2xl p-8 sm:p-14 border border-gold/40">
          <div className="absolute top-0 right-0 w-1/2 h-full opacity-15 pointer-events-none overflow-hidden">
            <Image 
              src="/scraped-images/236_BEST_1.jpg" 
              alt="Banasthali Scholars" 
              fill 
          ...
          <div className="relative z-10 max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-400/20 border border-amber-300/30 text-amber-300 text-xs font-semibold uppercase tracking-wider mb-6 backdrop-blur-md">
            ...
            <p className="text-lg sm:text-xl text-amber-100/90 mb-8 leading-relaxed font-light">
            ...
            <div className="flex flex-wrap gap-4">
              <a 
                href="#matcher-portal" 
                className="px-8 py-4 rounded-xl bg-amber-400 hover:bg-amber-300 text-slate-950 font-bold shadow-lg transition-all transform hover:-translate-y-0.5 flex items-center gap-2"
              >
      ...
      <div className="max-w-7xl mx-auto mb-16 grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-card dark:bg-[#1e0408] p-6 rounded-2xl shadow-sm border border-border/60 flex items-start gap-4">
          ...
          <div>
            <h3 className="font-bold text-foreground text-lg">100% Waiver</h3>
            <p className="text-sm text-muted-foreground mt-1">For daughters of Kargil Martyrs & top institutional merit holders.</p>
          </div>
        </div>
        ...
        <div className="bg-card dark:bg-[#1e0408] p-6 rounded-2xl shadow-sm border border-border/60 flex items-start gap-4">
          ...
          <div>
            <h3 className="font-bold text-foreground text-lg">30+ Endowments</h3>
            <p className="text-sm text-muted-foreground mt-1">Backed by Mahindra Trust, Bajaj Foundation, Kanoria & Dalmia.</p>
          </div>
        </div>
        ...
        <div className="bg-card dark:bg-[#1e0408] p-6 rounded-2xl shadow-sm border border-border/60 flex items-start gap-4">
          ...
          <div>
            <h3 className="font-bold text-foreground text-lg">Tribal & NE Aid</h3>
            <p className="text-sm text-muted-foreground mt-1">Special comprehensive schemes for North-East & rural tribal girls.</p>
          </div>
        </div>
        ...
        <div className="bg-card dark:bg-[#1e0408] p-6 rounded-2xl shadow-sm border border-border/60 flex items-start gap-4">
          ...
          <div>
            <h3 className="font-bold text-foreground text-lg">TA / RA Stipends</h3>
            <p className="text-sm text-muted-foreground mt-1">Paid teaching and research assistantships for M.Tech & Ph.D. scholars.</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto mb-16">
        <div className="bg-card dark:bg-[#1e0408] p-8 sm:p-10 rounded-3xl shadow-sm border border-border/60">
          <h2 className="text-2xl sm:text-3xl font-bold font-serif text-foreground mb-6 flex items-center gap-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
            <div className="p-5 rounded-2xl bg-muted/30 dark:bg-[#2a060c]/50 border border-border/40">
              <span className="w-8 h-8 rounded-full bg-primary text-white font-bold flex items-center justify-center mb-3 text-sm">1</span>
              <h4 className="font-bold text-foreground mb-1">Submit Admission Form</h4>
            ...
            <div className="p-5 rounded-2xl bg-muted/30 dark:bg-[#2a060c]/50 border border-border/40">
              <span className="w-8 h-8 rounded-full bg-primary text-white font-bold flex items-center justify-center mb-3 text-sm">2</span>
              <h4 className="font-bold text-foreground mb-1">Attach Income & Merit Proof</h4>
              <p className="text-muted-foreground">
            ...
            <div className="p-5 rounded-2xl bg-muted/30 dark:bg-[#2a060c]/50 border border-border/40">
              <span className="w-8 h-8 rounded-full bg-primary text-white font-bold flex items-center justify-center mb-3 text-sm">3</span>
              <h4 className="font-bold text-foreground mb-1">Committee Review & Disbursement</h4>
              <p className="text-muted-foreground">
