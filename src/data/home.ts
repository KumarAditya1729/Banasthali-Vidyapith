...
export const homeData = {
  ...
  panchmukhi: {
    ...
    pillars: [
      { id: "physical", name: "Physical (Sharirik)", icon: Activity, img: "/scraped-images/238_BEST_3.jpg", desc: "Featuring our own licensed Gliding and Flying Club (BVGFC) with a 3,600-ft airstrip and Cessna training fleet, alongside equestrian sports, martial arts, swimming, and physical endurance." },
      { id: "practical", name: "Practical (Vyavaharik)", icon: Lightbulb, img: "/scraped-images/239_BEST_4.jpg", desc: "Vocational mastery, engineering workshops, domestic crafts, and advanced laboratory research fostering true self-reliance and everyday competence." },
      { id: "aesthetic", name: "Aesthetic (Kala)", icon: Heart, img: "/scraped-images/240_BEST_5.jpg", desc: "Classical Kathak & Bharatanatyam dance, vocal and instrumental music, painting, and visual arts cultivating profound emotional intelligence and cultural heritage." },
      { id: "moral", name: "Moral (Naitik)", icon: Star, img: "/scraped-images/241_BEST_6.jpg", desc: "Value-based education, Gandhian simplicity (Khadi ethos), ethics, and community service shaping character and social responsibility." },
      { id: "intellectual", name: "Intellectual (Boudhik)", icon: BookOpen, img: "/scraped-images/280_Department_Library.JPG", desc: "Rigorous academic excellence across Humanities, Sciences, Law, Management, and Engineering from school level up to doctoral (Ph.D.) research." }
    ] as Pillar[]
  },
  campus: {
    ...
    places: [
      { name: "Central Library & Apaji Institute", img: "/scraped-images/280_Department_Library.JPG", span: "lg:col-span-2 lg:row-span-2" },
      { name: "Gliding & Flying Club (BVGFC)", img: "/scraped-images/238_BEST_3.jpg", span: "lg:col-span-1 lg:row-span-1" },
